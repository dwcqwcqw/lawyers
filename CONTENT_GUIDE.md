...
当前官网结构包含首页、七类业务详情、三位律师主页、家事指南、三份准备清单、关于、联系、法源、编辑准则与隐私说明。正文使用服务端HTML输出。正式文章采用真实作者资料，并区分用户授权发布与具名律师复核。
...
本轮按用户明确发布指示更新2篇已有网址、新增9篇，全部使用 `publication-approved`。没有新增虚构的审核人或律师复核日期。原A01/A02保持2026-09-13首次官网发布日期，其他9篇使用2026-09-19首次官网发布日期；内容更新日期均为2026-09-19。

分类按实际内容：A01/A1、A02/A2、B01/B2、B02/B6、C01/C1、D01/D1、E01/E2、F01/F1、G01/G2、H01/H3、I01/H2。H01和I01归上海与综合咨询，分别承接协议与离婚服务。文章保留原图和原生表格文字、FAQ，联系方式由网站统一模板维护。

`sourceUrls.kind` 增加 `professional-record`，专用于律师行业登记资料；页面区分其与法律原文、官方办理信息，不能将自行填报业务改称官方认证。正文链接与 `sourceRefs` 均保留对应关系；相关指南优先采用 `relatedSlugs` 的指定顺序，再补同专题，避免指定下一步阅读被列表排序覆盖。
